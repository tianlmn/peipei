...
```markdown
##前端:
1. react中文教程文档:[https://react.docschina.org/docs/hello-world.html](https://react.docschina.org/docs/hello-world.html)
2. es6文档:[http://es6.ruanyifeng.com/](http://es6.ruanyifeng.com/)
3. 书籍: 
js:
...
[css学习小网站](http://zh.learnlayout.com/)
